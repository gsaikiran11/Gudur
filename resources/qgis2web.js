...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32643',
            //extent: [793193.097900, 1737579.222000, 814421.458100, 1755159.226543],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([801717.229068, 1752464.557804, 802824.117911, 1752993.031394], map.getSize());
...
function doubleRingStyle() {
  return [
    ...
    new ol.styl            bottomLeftContainer.id = 'bottom-left-container';
            return bottomLeftContainer;
        })(),
    });
    map.addControl(bottomLeftContainer)
